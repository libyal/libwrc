...
{
	static char *function = "libwrc_notify_set_stream";
...
int libwrc_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libwrc_notify_stream_open";
...
int libwrc_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libwrc_notify_stream_close";
