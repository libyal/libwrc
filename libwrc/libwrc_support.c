...
const char *libwrc_get_version(
             void )
{
	return( (const char *) LIBWRC_VERSION_STRING );
}
...
int libwrc_get_access_flags_read(
     void )
{
	return( (int) LIBWRC_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libwrc_get_codepage";
...
int libwrc_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libwrc_set_codepage";
