           ...
           PyObject *keywords )
{
	...
	if( PyErr_WarnEx(
	     ...
	     "Call to deprecated function: get_number_of_strings",
	     1 ) < 0 )
	{
		return( NULL );
	}
           ...
           PyObject *keywords )
{
	...
	if( PyErr_WarnEx(
	     PyExc_DeprecationWarning,
	     "Call to deprecated function: get_string_identifier",
	     1 ) < 0 )
	{
		return( NULL );
	}
           ...
           PyObject *keywords )
{
	...
	if( PyErr_WarnEx(
	     PyExc_DeprecationWarning,
	     "Call to deprecated function: get_string_by_string_identifier",
	     1 ) < 0 )
	{
		return( NULL );
	}
