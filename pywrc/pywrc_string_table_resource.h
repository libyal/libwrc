...
#if !defined( _PYWRC_STRING_TABLE_RESOURCE_H )
#define _PYWRC_STRING_TABLE_RESOURCE_H
...
typedef struct pywrc_string_table_resource pywrc_string_table_resource_t;

struct pywrc_string_table_resource
{
	/* Python object initialization
	 */
	PyObject_HEAD

	/* The libwrc string table resource
	 */
	libwrc_string_table_resource_t *string_table_resource;
};

extern PyMethodDef pywrc_string_table_resource_object_methods[];
extern PyTypeObject pywrc_string_table_resource_type_object;
...
#endif /* !defined( _PYWRC_STRING_TABLE_RESOURCE_H ) */
