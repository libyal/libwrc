...
#if !defined( _PYWRC_STRING_H )
#define _PYWRC_STRING_H
...
extern PyMethodDef pywrc_string_object_methods[];
extern PyTypeObject pywrc_string_type_object;
