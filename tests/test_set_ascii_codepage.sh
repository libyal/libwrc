...
WRC_TEST_SET_ASCII_CODEPAGE="wrc_test_set_ascii_codepage";

if ! test -x ${WRC_TEST_SET_ASCII_CODEPAGE};
then
	WRC_TEST_SET_ASCII_CODEPAGE="wrc_test_set_ascii_codepage.exe";
fi

if ! test -x ${WRC_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${WRC_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${WRC_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
