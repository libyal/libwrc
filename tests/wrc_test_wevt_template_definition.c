/*
 * Library wevt_template_definition type test program
 *
...
#include "../libwrc/libwrc_wevt_template_definition.h"

/* Tests the libwrc_wevt_template_definition_free function
 * Returns 1 if successful or 0 if not
 */
int wrc_test_wevt_template_definition_free(
     void )
{
	...
	/* Test error cases
	 */
	result = libwrc_wevt_template_definition_free(
	          NULL,
	          &error );
...
#endif
{
	...
	/* TODO: add tests for libwrc_wevt_template_definition_get_offset */
