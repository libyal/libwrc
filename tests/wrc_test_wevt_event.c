/*
 * Library wevt_event type test program
 *
...
#include "../libwrc/libwrc_wevt_event.h"

/* Tests the libwrc_wevt_event_free function
 * Returns 1 if successful or 0 if not
 */
int wrc_test_wevt_event_free(
     void )
{
...
#endif
{
	...
	/* TODO: add tests for libwrc_wevt_event_initialize */

#endif /* defined( __GNUC__ ) && !defined( LIBWRC_DLL_IMPORT ) */

	WRC_TEST_RUN(
	 "libwrc_wevt_event_free",
	 wrc_test_wevt_event_free );

#if defined( __GNUC__ ) && !defined( LIBWRC_DLL_IMPORT )

	/* TODO: add tests for libwrc_wevt_event_get_identifier */

	/* TODO: add tests for libwrc_wevt_event_get_message_identifier */

	/* TODO: add tests for libwrc_wevt_event_get_template_definition */
