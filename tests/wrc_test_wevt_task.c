/*
 * Library wevt_task type test program
 *
...
#include "../libwrc/libwrc_wevt_task.h"

/* Tests the libwrc_wevt_task_free function
 * Returns 1 if successful or 0 if not
 */
int wrc_test_wevt_task_free(
     void )
{
...
#endif
{
	...
	/* TODO: add tests for libwrc_wevt_task_initialize */

#endif /* defined( __GNUC__ ) && !defined( LIBWRC_DLL_IMPORT ) */

	WRC_TEST_RUN(
	 "libwrc_wevt_task_free",
	 wrc_test_wevt_task_free );
