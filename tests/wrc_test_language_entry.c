/*
 * Library language_entry type test program
 *
 ...
 */
int wrc_test_language_entry_free(
     void )
{
	...
	/* Test error cases
	 */
	result = libwrc_language_entry_free(
	          NULL,
	          &error );
...
#endif
{
	...
	WRC_TEST_RUN(
	 ...
	 wrc_test_language_entry_free );

	/* TODO: add tests for libwrc_language_entry_get_number_of_values */

	/* TODO: add tests for libwrc_language_entry_get_value_by_index */
