/*
 * Library wevt_map type test program
 *
...
#include "../libwrc/libwrc_wevt_map.h"

/* Tests the libwrc_wevt_map_free function
 * Returns 1 if successful or 0 if not
 */
int wrc_test_wevt_map_free(
     void )
{
...
#endif
{
	...
	/* TODO: add tests for libwrc_wevt_map_initialize */

#endif /* defined( __GNUC__ ) && !defined( LIBWRC_DLL_IMPORT ) */

	WRC_TEST_RUN(
	 "libwrc_wevt_map_free",
	 wrc_test_wevt_map_free );
