/*
 * Library wevt_opcode type test program
 *
...
#include "../libwrc/libwrc_wevt_opcode.h"

/* Tests the libwrc_wevt_opcode_free function
 * Returns 1 if successful or 0 if not
 */
int wrc_test_wevt_opcode_free(
     void )
{
	...
	/* Test error cases
	 */
	result = libwrc_wevt_opcode_free(
	          NULL,
	          &error );
...
#endif
{
	...
	/* TODO: add tests for libwrc_wevt_opcode_initialize */

#endif /* defined( __GNUC__ ) && !defined( LIBWRC_DLL_IMPORT ) */

	WRC_TEST_RUN(
	 "libwrc_wevt_opcode_free",
	 wrc_test_wevt_opcode_free );
