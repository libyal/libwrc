/*
 * Library wevt_keyword type test program
 *
...
#include "../libwrc/libwrc_wevt_keyword.h"

/* Tests the libwrc_wevt_keyword_free function
 * Returns 1 if successful or 0 if not
 */
int wrc_test_wevt_keyword_free(
     void )
{
	...
	/* Test error cases
	 */
	result = libwrc_wevt_keyword_free(
	          NULL,
	          &error );
...
#endif
{
	...
	/* TODO: add tests for libwrc_wevt_keyword_initialize */

#endif /* defined( __GNUC__ ) && !defined( LIBWRC_DLL_IMPORT ) */

	WRC_TEST_RUN(
	 "libwrc_wevt_keyword_free",
	 wrc_test_wevt_keyword_free );
