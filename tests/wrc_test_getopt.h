...
#if !defined( _WRC_TEST_GETOPT_H )
#define _WRC_TEST_GETOPT_H
...
#define wrc_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t wrc_test_getopt(
                  int argument_count,
...
#endif /* !defined( _WRC_TEST_GETOPT_H ) */
