...
#if !defined( _LIBWRC_EXTERN_H )
#define _LIBWRC_EXTERN_H

/* To export functions from the libwrc DLL define LIBWRC_DLL_EXPORT
 * To import functions from the libwrc DLL define LIBWRC_DLL_IMPORT
